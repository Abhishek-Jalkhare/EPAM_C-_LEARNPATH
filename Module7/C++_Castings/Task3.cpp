...
class Shape {
public:
    virtual ~Shape() {} // Needed for dynamic_cast
...
public:
    ...
    void circleSpecific() const { std::cout << "Circle-specific method\n"; }
};

class Rectangle : public Shape {
public:
    void draw() const override { std::cout << "Drawing Rectangle\n"; }
    void rectangleSpecific() const { std::cout << "Rectangle-specific method\n"; }
};
